<footer id="footer" style='padding-bottom:80px'>
    ...
    <div class="container">
        <div class="col-xs-12 col-sm-4">
                <a href="trang-chu">
                    <img src="public/images/v.png" style="width: 80%;" class="img-fix f-logo" alt="smart-construction">
                </a>
            ...
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>Ngọc Lợi Shop</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>0828862808</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:alitrumcuoi@gmail.com">nguyenngocloib3thd</a></span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-2" style=margin-top:20px>
                <ul class="list-unstyled social pull-right">
                  <li><a href="https://www.facebook.com/nnloi.02418"><i class="fab fa-facebook-f"></i></a></li>
